...
from qube.src.api.omartestpy5controller import omartestpy5Controller
from qube.src.api.omartestpy5controller import omartestpy5ItemController
from qube.src.api.versioncontroller import omartestpy5ItemVersionController
...
api.add_resource(omartestpy5ItemVersionController, '/v1/omartestpy5/version')
api.add_resource(omartestpy5Controller, '/v1/omartestpy5')
api.add_resource(omartestpy5ItemController, '/v1/omartestpy5/<string:entity_id>')
