...
HELLO_VERSION = "/v1/omartestpy5/version"
...
class Testomartestpy5VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_omartestpy5_default_version(self, *args, **kwargs):
    ...
    def test_omartestpy5_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
